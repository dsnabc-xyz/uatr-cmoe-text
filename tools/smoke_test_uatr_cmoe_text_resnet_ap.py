...
from macls.models.uatr_cmoe_resnet_ap import UATRCMoETextResNetAP
...
def main():
    ...
    print("uatr_cmoe_text_resnet_ap_smoke: PASS")
    ...
    print(f"grad_norm/classifier: {float(grad_norm(model.classifier)):.6f}")
